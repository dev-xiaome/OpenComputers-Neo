package li.cil.oc.common.blockentity.traits.power
...
trait Common extends BaseBlockEntity {
  ...
  protected[oc] def tryAllSides(provider: (Double, Direction) => Double, fromOther: Double => Double, toOther: Double => Double): Unit = {
