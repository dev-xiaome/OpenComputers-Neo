...
class Server(id: Int, playerInventory: Inventory, val stack: ItemStack, serverInventory: Container, tier: Int, val rackSlot: Int)
  extends AbstractMenu(MenuTypes.SERVER.get(), id, playerInventory, serverInventory) {
