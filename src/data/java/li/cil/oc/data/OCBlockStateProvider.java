...
public class OCBlockStateProvider extends BlockStateProvider {
    public static final ResourceLocation GENERIC_TOP = ResourceLocation.fromNamespaceAndPath(OpenComputersNeo.ID(), "block/generic_top");
    public static final ResourceLocation BLOCK_SIDE = ResourceLocation.fromNamespaceAndPath(OpenComputersNeo.ID(), "block/block_side");

    public OCBlockStateProvider(PackOutput output, ExistingFileHelper existingFiles) {
        super(output, OpenComputersNeo.ID(), existingFiles);
    }
    ...
    protected void registerStatesAndModels() {
        ...
        simpleBlockWithItem(OCBlocks.CarpetedCapacitor().get(), models().cubeBottomTop(modelName(OCBlocks.CarpetedCapacitor().get()),
            ...
            GENERIC_TOP,
            ResourceLocation.fromNamespaceAndPath(OpenComputersNeo.ID(), "block/carpeted_capacitor_top")
        ));
        ...
        simpleBlockWithItem(OCBlocks.Relay().get(), models().cubeBottomTop(modelName(OCBlocks.Relay().get()),
            ResourceLocation.fromNamespaceAndPath(OpenComputersNeo.ID(), "block/switch_side"),
            GENERIC_TOP,
            ResourceLocation.fromNamespaceAndPath(OpenComputersNeo.ID(), "block/switch_top"))
        );
    ...
    private void caseBlock(Block block) {
        var model = models().getExistingFile(ResourceLocation.fromNamespaceAndPath(OpenComputersNeo.ID(), "case"));
        var runningModel = models().getExistingFile(ResourceLocation.fromNamespaceAndPath(OpenComputersNeo.ID(), "case_running"));
        horizontalBlock(block, s -> s.getValue(PropertyRunning.Running()) ? runningModel : model);
        simpleBlockItem(block, model);
    }

    private void screenBlock(Block block) {
        var model = models().getExistingFile(ResourceLocation.fromNamespaceAndPath(OpenComputersNeo.ID(), "screen"));
    ...
    private void cableBlock() {
        var core = models().getExistingFile(ResourceLocation.fromNamespaceAndPath(OpenComputersNeo.ID(), "block/cable_core"));
        var cableArm = models().getExistingFile(ResourceLocation.fromNamespaceAndPath(OpenComputersNeo.ID(), "block/cable_arm_cable"));
        var deviceArm = models().getExistingFile(ResourceLocation.fromNamespaceAndPath(OpenComputersNeo.ID(), "block/cable_arm_device"));
        var disconnected = models().getExistingFile(ResourceLocation.fromNamespaceAndPath(OpenComputersNeo.ID(), "block/cable_disconnected"));
