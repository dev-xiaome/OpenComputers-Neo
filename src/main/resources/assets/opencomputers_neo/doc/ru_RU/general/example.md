...
![Это всплывающее сообщение...](opencomputers_neo:textures/gui/printer_ink.png)
![Это всплывающее сообщение...](opencomputers_neo:/textures/gui/printer_material.png)
...
![Это рендирится напрямую.](oredict:opencomputers_neo:assembler)
## Заголовок второго уровня [снова со *ссылкой*, но __немного__ длиннее](../block/adapter.md)

![Это еще одно всплывающее сообщение.](item:opencomputers_neo:transistor)
...
Это тест![](oredict:opencomputers_neo:cpu1) картинки в тексте kakakakalalsd 123 as

Это один тест![](oredict:opencomputers_neo:cpu1)
