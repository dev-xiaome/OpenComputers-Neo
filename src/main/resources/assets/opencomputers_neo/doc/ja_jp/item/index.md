...
このインデックスは、OpenComputers のドキュメント化されているすべてのアイテムをリストしています。ブロックをお探しの場合は、[ブロックインデックス](../block/index.md) を参照してください。

使用されているレシピセットによっては、これらの一部が利用できない場合があることに注意してください。
...
### カード
* [抽象バスカード (AbstractBus Card)](abstractbuscard.md)
* [データカード](datacard1.md)
* [デバッグカード](debugCard.md)
* [グラフィックスカード](graphicscard1.md)
* [インターネットカード](internetcard.md)
* [リンクカード](linkedcard.md)
...
* [チャンクローダーアップグレード](chunkloaderupgrade.md)
* [クラフトアップグレード](craftingupgrade.md)
* [データベースアップグレード](databaseupgrade1.md)
* [経験値アップグレード](experienceupgrade.md)
* [発電機アップグレード](generatorupgrade.md)
...
* [算術論理演算装置 (ALU)](alu.md)
* [矢印キー](arrowkeys.md)
* [ボタンの塊](buttongroup.md)
* [カード](card.md)
* [回路基板](circuitboard.md)
* [制御ユニット (CU)](controlunit.md)
* [カッティングワイヤー](cuttingwire.md)
* [ディスク](disk.md)
* [インターウェッブ](interweb.md)
* [マイクロチップ](chip1.md)
* [テンキー](numpad.md)
* [プリント回路基板 (PCB)](printedcircuitboard.md)
...
* [ドローンケース](dronecase1.md)
* [マイクロコントローラーケース](microcontrollercase1.md)
* [タブレットケース](tabletcase1.md)
