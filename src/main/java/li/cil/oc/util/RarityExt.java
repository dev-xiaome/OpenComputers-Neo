...
public final class RarityExt {
    public static final EnumProxy<Rarity> LEGENDARY = new EnumProxy<>(Rarity.class, -1, "opencomputers_neo:legendary", (UnaryOperator<Style>)(Style s) -> s.withColor(ChatFormatting.GOLD));
