...
object WirelessNetworkDebugRenderer {
  ...
  def onRenderWorldLastEvent(e: RenderWorldLastEvent): Unit = {
    if (Settings.rTreeDebugRenderer) {
      ...
      val world = ObfuscationReflectionHelper.getPrivateValue(classOf[net.minecraft.client.renderer.RenderGlobal], e.context, "theWorld", "field_72769_h", "r").asInstanceOf[Level]
