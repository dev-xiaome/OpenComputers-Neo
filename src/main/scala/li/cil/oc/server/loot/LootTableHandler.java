...
/** Adds OpenComputersNeo content to vanilla dungeon and village chest tables. */
public final class LootTableHandler {
    ...
    public void onLootTableLoad(LootTableLoadEvent event) {
        ...
        if (floppy == null) {
            OpenComputersNeo.log().warn("Could not inject loot disks: the floppy item is not registered yet.");
            return;
        }
