...
public final class LootFunctions {
    public static final ResourceLocation DYN_ITEM_DATA =
            ResourceLocation.fromNamespaceAndPath(OpenComputersNeo.ID(), "item_data");

    public static final ResourceLocation DYN_VOLATILE_CONTENTS =
            ResourceLocation.fromNamespaceAndPath(OpenComputersNeo.ID(), "volatile_contents");

    private static final DeferredRegister<LootItemFunctionType<?>> DR =
            DeferredRegister.create(Registries.LOOT_FUNCTION_TYPE, OpenComputersNeo.ID());
