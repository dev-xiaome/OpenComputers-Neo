...
object EnvironmentProviderBlocks extends EnvironmentProvider {
  override def getEnvironment(stack: ItemStack): Class[_] = stack.getItem match {
    case block: BlockItem =>
      ...
      else if (isOneOf(block.getBlock, OCBlocks.CaseTier1, OCBlocks.CaseTier2, OCBlocks.CaseTier3, OCBlocks.CaseCreative, OCBlocks.Microcontroller)) classOf[Machine]
      else if (isOneOf(block.getBlock, OCBlocks.HologramTier1, OCBlocks.HologramTier2)) classOf[blockentity.Hologram]
      ...
      else if (isOneOf(block.getBlock, OCBlocks.ScreenTier2, OCBlocks.ScreenTier3)) classOf[common.component.Screen]
