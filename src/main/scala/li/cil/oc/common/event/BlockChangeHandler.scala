...
import net.minecraft.world.{IWorldAccess, Level}
...
object BlockChangeHandler {
  ...
  private class Listener(world: Level) extends IWorldAccess {
    ...
    override def playAuxSFX(player: Player, sfxType: Int, x: Int, y: Int, z: Int, data: Int) {}
    ...
    override def playSoundToNearExcept(player: Player, soundName: String, x: Double, y: Double, z: Double, volume: Float, pitch: Float) {}
